...
function FallbackGradient() {
  return (
    <div className="absolute inset-0">
      <div className="absolute -left-24 -top-24 h-80 w-80 rounded-full bg-pink-200/25 blur-3xl" />
      <div className="absolute right-[-10%] top-10 h-96 w-96 rounded-full bg-cyan-200/20 blur-3xl" />
